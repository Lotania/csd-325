...
print("for Sitka in 2018. Once you view your chosen graph, exit out of the graph to")
print("move on in the program. Then, you can choose to view another graph or exit.\n")

print("Would you like to see the highs or lows, or leave? Type 1, 2, or 3")
...
while(selection != '3'):
    ...
    if(selection == '1'):
        ...
        with open(filename) as f:
            ...
            selection = input('HIGH, LOW, or EXIT ')
            cap_selection = selection.upper()
